export const recruitDetails = [
  ...
  {
    id: 'd9016c87-1de3-46a5-84d5-6cbb2146a28a',
    created: '2023-03-23',
    title: '웹 게임 개발 프로젝트 참여 인원 모집합니다',
    description:
      '모바일 화면에서도 즐길 수 있는 웹 게임을 제작하고 있습니다. 프론트엔드와 디자이너분들을 찾고 있습니다. React, HTML, CSS를 사용합니다. 기획자도 함께 참여하면 더욱 좋겠습니다!',
    contactInfo: '이메일 : example@gmail.com',
    recruitHashtag: ['프론트엔드', '백엔드'],
    recruitTech: ['react', 'node.js'],
    ...
    comments: [
      {
        nickName: 'codingking',
        created: '2023-03-24',
        content: '안녕하세요! 프론트엔드 개발자로 지원합니다.',
      },
      {
        nickName: 'backendmaster',
        created: '2023-03-24',
        content: '백엔드 개발자로 지원합니다. 연락주세요!',
      },
    ],
  },
  {
    ...
    contactInfo: 'https://github.com/2022-Summer-Bootcamp-teamG/puppy-classification',
    recruitHashtag: ['프론트엔드', '백엔드', '모바일', '기타'],
    recruitTech: ['react', 'spring', 'aws'],
  ...
  {
    id: 'd9bc0128-5bf5-4b26-9214-4eb6e4e6f26c',
    password: '$2y$10$0vKKcKpwwd30wmf5X8W9ROaHvby5jF1E2gk5h5EBHwL6FLewyq/wK',
    created: '2023-03-24',
    title: '백엔드 개발자 모집합니다',
    description:
      '우리 회사에서는 웹 서비스를 개발하고 있습니다. 백엔드 개발자 1명을 찾고 있습니다.',
    contactInfo: 'https://open.kakao.com/o/s7VdkF',
    recruitHashtag: ['백엔드', '웹서비스'],
    recruitTech: ['node.js', 'express', 'mongoDB'],
    ...
    comments: [
      {
        nickName: 'codingmaniac',
        created: '2023-03-24',
        content:
          '안녕하세요, 백엔드 개발자로 지원합니다. 경력과 기술 스택은 이력서에 자세히 적어놓았습니다.',
      },
      {
        nickName: 'techguru',
        created: '2023-03-24',
        content: '백엔드 개발자로 지원합니다. 참고로 AWS와 Docker를 이용한 개발 경험이 있습니다!',
      },
    ],
  },
];
